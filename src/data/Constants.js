...
export const contactInfo = [
  ...
  {
    label: "آدرس دفتر",
    describe: "تهران، پونک، خیابان اشرفی اصفحانی، خیابان فلاح زاده، همیلا سنتر",
  },
];
...
export const teamMembers = [
  {
    ...
    role: "مدیرعامل",
    profile: Team_1,
    bio: "برنامه‌نویس و طراح وبسایت و دانشجوی ارشد علوم کامپیوتر. بنده به عنوان مدیرعامل این امپراتوری و یکی از اعضای تیم آموزشی آکادمی امپراتوری کد بسیار خوشنودم که به شما بزرگواران خدمت میکنم.",
  },
  {
    name: "پارسا عربی",
